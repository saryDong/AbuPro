...
public class ArticleItemView extends CardView {
    ...
    public void bindView(Article article) {
        mArticle = article;
        mUserName.setText(null==article.getUser()?"null":article.getUser().getUsername());
        ...
        GlideApp.with(this).load(null==article.getUser()?R.drawable.bg_btn:article.getUser().getAvatar())
