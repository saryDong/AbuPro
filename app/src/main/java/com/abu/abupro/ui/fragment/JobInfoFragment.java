...
import com.abu.abupro.presenter.JobInfoPresenter;
...
@FragmentScoped
public class JobInfoFragment extends BaseRefreshableListFragment<Question> implements HotQuestionContract.View{

    @Inject
    JobInfoPresenter mHotQuestionPresenter;
