...
public class User extends AVUser {
    public static final String ARTICALE_COLLECT="artitle_collect";

    public void setArticaleCollect(String str){
        put(ARTICALE_COLLECT,str);
        saveInBackground();
    }

    public String getArticleCollect(){
        return getString(ARTICALE_COLLECT);
    }
