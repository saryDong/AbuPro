 ...
 */
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemDragHelperCallback.OnItemMoveListener {
    // 我的频道 标题部分
    ...
    private void update() {
        mRemoveInterface.onRemove(mMyChannelItems);
    }
    ...
    RemoveInterface mRemoveInterface;
    public interface RemoveInterface{
        void onRemove(List<ChannelEntity> entities);
    }

    public void onRemove(RemoveInterface removeInterface){
